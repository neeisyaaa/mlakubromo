...
<div class="page-header">
    ...
    <p class="page-subtitle">Buat user baru dalam sistem</p>
</div>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-user-plus me-2"></i>Form User Baru</h5>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-warning">
                    ...
                    <p class="mb-0">Pastikan data yang dimasukkan sudah benar sebelum menyimpan.</p>
                </div>
            </div>
        </div>
    </div>
