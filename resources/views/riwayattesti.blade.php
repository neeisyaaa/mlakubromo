...
<body>
    ...
    <section class="about">
        <div class="container animate-on-scroll">
            <h2>Riwayat <span>Testimoni</span></h2>
            <p>Lihat semua testimoni dan ulasan yang pernah Anda berikan untuk perjalanan bersama MlakuBromo.ID. Bagikan pengalaman terbaik Anda untuk membantu traveler lain.</p>
        </div>
    </section>
    ...
    <div class="profile-section">
        ...
        <div class="profile-card">
            <div class="tabs">
                <h3 style="margin: 0; color: #333; font-size: 24px;">Riwayat Testimoni</h3>
            ...
            <div class="bookings-table">
                ...
                <div class="table-header-card">
                    <div class="table-header-row">
                        ...
                        <div class="table-header-cell">Rating</div>
                        <div class="table-header-cell">Testimoni</div>
                        <div class="table-header-cell">Status</div>
                        <div class="table-header-cell">Publikasi</div>
                ...
                <div class="table-row-card">
                    <div class="table-data-row">
                        ...
                        <div class="table-data-cell">Perjalanan yang sangat menyenangkan!</div>
                        <div class="table-data-cell"><span class="status-badge status-aktif">Aktif</span></div>
                        <div class="table-data-cell">Dipublikasi</div>
                        <div class="table-data-cell">
                            <button class="detail-btn" onclick="showTestimonialDetail(1)">
                                <i class="fas fa-eye"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div class="table-row-card">
                    <div class="table-data-row">
                        ...
                        <div class="table-data-cell">15/08/2025</div>
                        <div class="table-data-cell">⭐⭐⭐⭐</div>
                        <div class="table-data-cell">Pengalaman yang tak terlupakan!</div>
                        <div class="table-data-cell"><span class="status-badge status-selesai">Selesai</span></div>
                        <div class="table-data-cell">Dipublikasi</div>
                        <div class="table-data-cell">
                            <button class="detail-btn" onclick="showTestimonialDetail(2)">
                                <i class="fas fa-eye"></i>
                            </button>
                        </div>
                    </div>
...
<script>
        ...
        function showOrderHistory() {
            const tableContainer = document.querySelector('.bookings-table');
        ...
        function showTestimonialHistory() {
            const tableContainer = document.querySelector('.bookings-table');
            tableContainer.innerHTML = `
                <!-- Header Card -->
                <div class="table-header-card">
        ...
        function showTestimonialDetail(testimonialId) {
