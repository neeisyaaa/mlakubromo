...
<head>
    ...
    <title>Travel to Malang Bromo - MlakuBromo.ID</title>
...
<body>
    ...
    <section class="open-trip section" id="paket">
        <div class="container">
            <h2 class="section-title animate-on-scroll">Travel <span class="highlight">to </span> Malang <span class="highlight">Bromo </span></h2>
            <p class="section-subtitle animate-on-scroll">
            Bergabunglah dalam perjalanan seru 3 hari 2 malam ke Malang dan Bromo. Nikmati sunrise memukau di Gunung Bromo, pengalaman memetik apel langsung dari kebun, hingga kunjungan ke destinasi populer seperti Jatim Park 2, Museum Angkut, Eco Green Park, dan Coban Rondo.
            </p>
            ...
            <div class="price-card animate-on-scroll">
                <div class="price-header">                    
                    ...
                    <div class="price-header-content">
                        <div class="price-badge">Private Trip</div>
                        <h3 class="trip-title">Travel <span class="highlight">to </span> Malang <span class="highlight">Bromo </span></h3>
                ...
                <div class="price-content">
                    ...
                    <div class="price-main">
                        <div>
                            <span class="price-amount">IDR 2.000.000</span>
    ...
    <section class="destinasi-section">
        <div class="container">
            <div class="destinasi-content animate-on-scroll">
                <h2 class="section-title">Destinasi <span class="highlight">Travel </span>to Malang Bromo</h2>
    ...
    <section class="facilities-section">
        <div class="container">
            <div class="facilities-content animate-on-scroll">
                <h2 class="section-title">Fasilitas <span class="highlight">Travel </span>to <span class="highlight">Malang</span> Bromo</span></h2>
                <p class="section-subtitle">
            ...
            <div class="facilities-grid">
                <div class="facility-card animate-on-scroll">
                    ...
                    <div class="facility-info">
                        <h3>Tiket masuk tempat wisata</h3>
                        <p>Tiket masuk ke semua destinasi wisata yang dikunjungi selama perjalanan</p>
                        <div class="facility-features">
                            <span><i class="fas fa-tree"></i> All Access</span>
                            <span><i class="fas fa-map-marker-alt"></i> Multi Destinasi</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="facility-card animate-on-scroll">
                    ...
                    <div class="facility-info">
                        <h3>Transport city car</h3>
                        <p>Kendaraan city car yang nyaman untuk perjalanan antar destinasi</p>
                        <div class="facility-features">
                            <span><i class="fas fa-road"></i> Comfortable</span>
                ...
                <div class="facility-card animate-on-scroll">
                    ...
                    <div class="facility-info">
                        <h3>2 malam stay di hotel bintang 3</h3>
                        <p>Penginapan selama 2 malam di hotel berbintang 3 dengan fasilitas lengkap</p>
                        <div class="facility-features">
                            <span><i class="fas fa-star"></i> Bintang 3</span>
                            <span><i class="fas fa-wifi"></i> Fasilitas Lengkap</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="facility-card animate-on-scroll">
                    ...
                    <div class="facility-info">
                        <h3>Welcome Snack and drink</h3>
                        <p>Snack dan minuman selamat datang untuk memulai perjalanan dengan menyenangkan</p>
                        <div class="facility-features">
                            <span><i class="fas fa-coffee"></i> Fresh Drink</span>
                            <span><i class="fas fa-cookie"></i> Local Snack</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="package-card animate-on-scroll">
                    ...
                    <div class="package-content">
                        ...
                        <div class="package-price">
                            <a href="javascript:void(0)" class="package-btn" onclick="checkLoginAndOrder()">Pesan Sekarang!</a>
    ...
    <div id="paymentModal" class="payment-modal">
        <div class="payment-modal-content">
            <div class="payment-modal-header">
                <h3 class="payment-modal-title">Booking Travel to Malang Bromo</h3>
                ...
                <form id="bookingForm">
                    ...
                    <div class="booking-summary">
                        ...
                        <div class="summary-total">
                            ...
                            <span id="totalPrice">Rp 2.005.000</span>
                        </div>
                    </div>
