...
<head>
    ...
    <title>Paket Bromo Ijen WNA - MlakuBromo.ID</title>
...
<body>
    ...
    <section class="open-trip section" id="paket">
        <div class="container">
            <h2 class="section-title animate-on-scroll">Paket <span class="highlight">Bromo </span> Ijen WNA</h2>
            <p class="section-subtitle animate-on-scroll">
            Nikmati petualangan seru ke Gunung Bromo dan Kawah Ijen. Saksikan sunrise menakjubkan di Bromo, fenomena Blue Fire yang langka di Ijen, serta jelajahi lautan pasir, savana hijau, dan destinasi ikonik lainnya dalam satu perjalanan tak terlupakan.
            </p>
            ...
            <div class="price-card animate-on-scroll">
                <div class="price-header">                    
                    ...
                    <div class="price-header-content">
                        ...
                        <h3 class="trip-title">Paket <span class="highlight">Bromo </span> Ijen WNA</h3>
    ...
    <section class="destinasi-section">
        <div class="container">
            <div class="destinasi-content animate-on-scroll">
                <h2 class="section-title">Destinasi <span class="highlight">Paket Bromo</span> Ijen WNA</h2>
    ...
    <section class="facilities-section">
        <div class="container">
            <div class="facilities-content animate-on-scroll">
                <h2 class="section-title">Fasilitas <span class="highlight">Paket Bromo</span> Ijen WNA</h2>
                <p class="section-subtitle">
            ...
            <div class="facilities-grid">
                ...
                <div class="facility-card animate-on-scroll">
                    ...
                    <div class="facility-info">
                        <h3>Tiket Kawah Ijen</h3>
                        <p>Tiket masuk ke kawasan wisata Kawah Ijen yang spektakuler</p>
                        <div class="facility-features">
                            <span><i class="fas fa-fire"></i> Blue Fire</span>
                            <span><i class="fas fa-mountain"></i> Kawah Aktif</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="facility-card animate-on-scroll">
                    ...
                    <div class="facility-info">
                        <h3>Local Guide</h3>
                        <p>Pemandu wisata lokal berpengalaman untuk menjelaskan sejarah dan budaya</p>
                        <div class="facility-features">
                            <span><i class="fas fa-language"></i> Multilingual</span>
                            <span><i class="fas fa-star"></i> Berpengalaman</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="facility-card animate-on-scroll">
                    ...
                    <div class="facility-info">
                        <h3>Finish drop Ketapang/Banyuwangi</h3>
                        <p>Pengantaran akhir ke Ketapang atau Banyuwangi sesuai kebutuhan perjalanan</p>
                        <div class="facility-features">
                            <span><i class="fas fa-route"></i> Flexible Drop</span>
                            <span><i class="fas fa-ship"></i> Ferry Access</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="paymentModal" class="payment-modal">
        <div class="payment-modal-content">
            <div class="payment-modal-header">
                <h3 class="payment-modal-title">Booking Paket Bromo Ijen WNA</h3>
